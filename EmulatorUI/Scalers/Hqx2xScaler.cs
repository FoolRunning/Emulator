...
{
    public sealed class Hqx2xScaler : IDisplayScaler
    {
        public void Scale(RgbColor[] input, Size inputSize, RgbColor[] output, Size outputSize)
        {
            ...
            unsafe
            {
                fixed (RgbColor* inPx = input)
                {
                    fixed (RgbColor* outPx = output)
                    {
                        int* inputPx = (int*)inPx;
                        int* outputPx = (int*)outPx;
                        Scale2(inputPx, outputPx, inputSize.Width, inputSize.Height);
                    }
                }
            }
        ...
        #region Hqx_2x code
        // NOTE: Code has been changed from the original hqxSharp implementation in the following ways:
        // * removed support for alpha component (not needed and performs faster without it)
        // * optimized some code that was very inefficient in Interpolation class
        ...
        private static unsafe void Scale2(int* sp, int* dp, int Xres, int Yres, int trY = 48, int trU = 7, int trV = 6)
        {
        ...
        /// <summary>
        /// Compares two RGB colors according to the provided Y, U, V and A thresholds.
        /// </summary>
        /// <param name="c1">An RGB color.</param>
        /// <param name="c2">A second RGB color.</param>
        /// <param name="trY">The Y (luminance) threshold.</param>
        /// <param name="trU">The U (chrominance) threshold.</param>
        /// <param name="trV">The V (chrominance) threshold.</param>
        /// <returns>Returns true if colors differ more than the thresholds permit, otherwise false.</returns>
        private static bool Diff(int c1, int c2, int trY, int trU, int trV)
        {
